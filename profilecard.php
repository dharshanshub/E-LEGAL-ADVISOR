                        ...
                        <div class="col-sm-8">
                            <div class="card-block">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <p class="m-b-10 f-w-600"><B>COURT</B></p>
                                        <h6 class="text-muted f-w-400"><?php echo $courts ?></h6>
                                    </div>
                                </div>
                                ...
                                <div class=button button1>
                                    <form action="lawyersprofile.php" method="post">

                                        <input type="submit" value="Contact lawyer" />

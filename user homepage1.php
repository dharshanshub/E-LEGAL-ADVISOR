...
<link hef="userhompage.css" rel="stylesheet" />
...
<div id="header-wrapper">
	<div id="header">
	 ...
	 <div>
					...
					<h2 style="color:white; text-align: center; font-weight: bold;"><b>Login Successful! HI,<?php
						echo $username ?></b><h2>
...
<div id="wrapper">
	<div id="page-wrapper">
		<div id="page">
			<div id="content">
				   <h2 style="color: #fb607f"> Welcome to E-legal advisor!</h2>
